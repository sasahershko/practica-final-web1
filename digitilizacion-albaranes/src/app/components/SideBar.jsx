                    ...
                    <ul className='space-y-4 text-left'>
                        <li>
                            <div className='py-3 px-4 rounded-xl hover:bg-indigo-50 transition-colors'>
                                <Link href='/pages/sideBar/summary' className='flex items-center gap-3'>
                            ...
                            <div className='flex items-center py-3 px-4 rounded-xl hover:bg-indigo-50 transition-colors'>
                                <Link href='/pages/sideBar/addClient' className='flex items-center gap-3'>
                            ...
                            <div className='flex items-center py-3 px-4 rounded-xl hover:bg-indigo-50 transition-colors'>
                                <Link href='/pages/sideBar/projects' className='flex items-center gap-3'>
                            ...
                            <div className='flex items-center py-3 px-4 rounded-xl hover:bg-indigo-50 transition-colors'>
                                <Link href='/pages/sideBar/deliveryNotes' className='flex items-center gap-3'>
                            ...
                            <div className='flex items-center py-3 px-4 rounded-xl hover:bg-indigo-50 transition-colors'>
                                <Link href='/pages/sideBar/suppliers' className='flex items-center gap-3'>
                                    ...
                                    <span className='text-blue-900 text-[18px]'>Suppliers</span>
                                </Link>
                            </div>
                            
                            <div className='flex items-center py-3 px-4 rounded-xl hover:bg-indigo-50 transition-colors'>
                                <Link href='/pages/sideBar/settings' className='flex items-center gap-3'>
